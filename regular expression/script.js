...
let reg = /Anil/; // This is a regular expression literal in js
reg = /Anil/g; // g means global
// reg = /harry/i; // i means case insensitive

console.log(reg);
console.log(reg.source);

let s = "This is great code with Anil and also Anil bro";
...
// console.log(result2);
// --> This will only print true if the "reg" is there in the string "s"
...
let result5 = s.replace(reg, "Arun");
console.log(result5);
